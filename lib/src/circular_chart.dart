...
class CircularChart {
  ...
  factory CircularChart.fromData({
    ...
    return new CircularChart(stacks, chartType, edgeStyle: edgeStyle ?? SegmentEdgeStyle.flat);
  }
}
...
class CircularChartTween extends Tween<CircularChart> {
  ...
  CircularChart lerp(double t) => new CircularChart(
        _stacksTween.lerp(t),
        begin?.chartType ?? CircularChartType.Radial,
        edgeStyle: end?.edgeStyle ?? SegmentEdgeStyle.flat ,
      );
}
